...
public class HeroiDAO {
    ...
    private static final String sqlconsultaheroi = "SELECT * FROM heroi order by id";
    private static final String sqlinserir = "INSERT INTO heroi (id, nome, forcageral) VALUES (?, ?, ?)";
    private static final String sqlalterar = "UPDATE heroi SET nome = ?, forcageral = ? WHERE id = ?";
    ...
    public boolean Inserir(Heroi heroi) {
        try {
            ...
            pstdados.setDouble(3, heroi.getForcaGeral());
    ...
    public boolean Alterar(Heroi heroi) {
       try {
            ...
            pstdados.setDouble(2, heroi.getForcaGeral());
            pstdados.setInt(3, heroi.getId());
            int resposta = pstdados.executeUpdate();
            pstdados.close();
            //DEBUG
    ...
    public Heroi getHeroi() {
        ...
        if (rsdados != null) {
            try {
                ...
                double forca = rsdados.getDouble("forcageral");
